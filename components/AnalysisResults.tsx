...
Generated by TradingXbert.com 🤖✨
  ...
  const handleSaveToJournal = () => {
    ...
    if (typeof window !== 'undefined' && analysis) {
      ...
      const market = localStorage.getItem('currentMarket') || 'Crypto';
      const style = localStorage.getItem('currentStyle') || 'Day Trade';
      ...
      if (preview) {
        ...
        const journal = JSON.parse(localStorage.getItem('tradingxbert_journal') || '[]');
        journal.unshift(entry);
        localStorage.setItem('tradingxbert_journal', JSON.stringify(journal));
