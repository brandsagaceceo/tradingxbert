  ...
  return (
    <div className="w-full max-w-5xl mx-auto animate-in fade-in-0 zoom-in-95 duration-500">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        {/* Trend & Structure */}
        <AnalysisCard title="Trend & Structure" icon="📊" iconGradient="from-blue-400 to-cyan-400">
          <p className="text-neutral-200 leading-relaxed text-lg">{analysis.trendSummary}</p>
        </AnalysisCard>

        {/* Pattern Summary */}
        <AnalysisCard title="Pattern Summary" icon="🔍" iconGradient="from-purple-400 to-pink-400">
          <p className="text-neutral-200 leading-relaxed text-lg">{analysis.patternSummary}</p>
        </AnalysisCard>

        {/* Key Levels */}
        <AnalysisCard title="Key Levels" icon="🎯" iconGradient="from-red-400 to-orange-400">
          <p className="text-neutral-200 leading-relaxed text-lg whitespace-pre-line font-mono">{analysis.keyLevels}</p>
        </AnalysisCard>

        {/* Risk Level */}
        <AnalysisCard title="Risk Assessment" icon="⚠️" iconGradient="from-yellow-400 to-amber-400">
      ...
      <div className="space-y-6 mb-8">
        {/* Style Notes */}
        <AnalysisCard title="Trading Strategy" icon="💡" iconGradient="from-emerald-400 to-green-400" fullWidth>
          <p className="text-neutral-200 leading-relaxed text-lg">{analysis.styleNotes}</p>
        </AnalysisCard>

        {/* Emotion Check */}
        {analysis.emotionSummary && (
          <AnalysisCard title="Psychology Check" icon="🧠" iconGradient="from-indigo-400 to-purple-400" fullWidth>
        ...
        {/* Risk Plan */}
        {analysis.riskPlan && (
          <AnalysisCard title="Risk Management Plan" icon="💰" iconGradient="from-[#FFD700] to-[#FFA500]" fullWidth>
        ...
        {analysis.confidenceBreakdown && (
          <AnalysisCard title="Confidence Breakdown" icon="📈" iconGradient="from-teal-400 to-cyan-400" fullWidth>
