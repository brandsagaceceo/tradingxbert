        ...
        >
          <div className="bg-gradient-to-r from-[#0A0A0A]/95 to-[#1A1A1A]/95 backdrop-blur-lg border-t border-neutral-700/50 px-4 py-3 shadow-2xl">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="w-full bg-gradient-to-r from-[#6366F1] to-[#8B5CF6] hover:from-[#5558E3] hover:to-[#7C4FE8] text-white font-bold py-3 px-6 rounded-xl shadow-lg transition-all duration-300 flex items-center justify-center gap-2 relative overflow-hidden"
            >
